/**
 * Lightweight checks for marketplace booking payment rules and serializers.
 * Run: npx tsx scripts/marketplace-booking-payment-smoke.ts
...
function main() {
  ...
  console.log("marketplace-booking-payment-smoke: OK");
}
