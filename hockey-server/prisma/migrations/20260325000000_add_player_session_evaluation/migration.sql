...
-- CreateIndex
CREATE INDEX "PlayerSessionEvaluation_trainingId_idx" ON "PlayerSessionEvaluation"("trainingId");

-- CreateIndex
CREATE INDEX "PlayerSessionEvaluation_playerId_idx" ON "PlayerSessionEvaluation"("playerId");
