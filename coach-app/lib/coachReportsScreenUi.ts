...
export const COACH_REPORTS_SCREEN_COPY = {
  ...
  emptyBodyNone:
    'Отчёты собираются из тренировочного потока и голосовых заметок, затем попадают к игроку. Ниже — быстрые переходы в те же сценарии и к списку игроков.',
  emptyRetryEndpoint: 'Проверить снова',
  emptyCtaTraining: 'Тренировочный поток',
  emptyCtaVoice: 'Голосовая заметка',
  emptyCtaPlayers: 'К игрокам',
  quickTitle: 'Дальше работа с материалом',
  quickHint:
    'Тот же контур, из которого появляются отчёты — плюс игроки и сохранённые материалы.',
  quickPlayers: 'Игроки',
  quickTraining: 'Тренировка',
  quickVoice: 'Голос',
